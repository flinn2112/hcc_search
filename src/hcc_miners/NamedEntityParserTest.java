...
public class NamedEntityParserTest {
    ...
    public static final String CONFIG_FILE = "hcc_miners/tika-config.xml";
    ...
    public void testParse() throws Exception {
        ...
        String inputDirPath = "x:\\tmp\\tikaNERTest";
        int count = 0;
        try {
            ...
            for (File filename : listDir) {
                ...
                if (!filename.getName().equals(".DS_Store") && count < 3573) {
                    ...
                    FileReader fReader = new FileReader(absoluteFilename) ;
