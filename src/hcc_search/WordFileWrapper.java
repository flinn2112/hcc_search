...
/* ====================================================================
         ...
         */
        public final class WordFileWrapper extends POIOLE2TextExtractor {
             ...
             */
            public WordFileWrapper(InputStream is) throws IOException {
             ...
             */
            public WordFileWrapper(POIFSFileSystem fs) throws IOException {
             ...
             */
            public WordFileWrapper(HWPFDocument doc) {
                super (doc);
                this .doc = doc;
            }
            ...
            public static void main(String[] args) throws IOException {
                ...
                */
                ...
                FileInputStream fin = new FileInputStream("/Users/frankkempf/Documents/test.doc");
                WordFileWrapper extractor = new WordFileWrapper(fin);
            ...
            public String getTextFromPieces() {
                ...
                Iterator textPieces = doc.getTextTable().getTextPieces()
                        .iterator();
